...
#ifndef READERPRO_SWIFT_H
#define READERPRO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ReaderPro",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9ReaderPro20AVAudioPlayerAdapter")
@interface AVAudioPlayerAdapter : NSObject <AVAudioPlayerDelegate>
...
SWIFT_CLASS("_TtC9ReaderPro11AppDelegate")
